...
export default function Search(props: Props) {
  ...
  const searchButton = () => {
    console.log('yhhhhhhhhhhhhhhhhhhhhhh');

    dispatch({ type: 'SEARCH', payload: { select, search } });
  };
      ...
      <form className='form-inline searchbox'>
        <div className='md-form my-0'>
          <input
            ...
            aria-label='Search'
          />
          <button type='button' onClick={(e: any) => searchButton()} className='btn searchbtn btn-primary'>
            Search
          </button>
        </div>
      </form>
